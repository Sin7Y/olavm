...
use olavm_plonky2::plonk::plonk_common::reduce_with_powers_ext_circuit;
use olavm_plonky2::timed;
use olavm_plonky2::util::timing::TimingTree;
...
impl<F: RichField + Extendable<D>, const D: usize> Stark<F, D> for KeccakStark<F, D> {
    ...
    fn eval_ext_circuit(
        &self,
        builder: &mut olavm_plonky2::plonk::circuit_builder::CircuitBuilder<F, D>,
...
mod tests {
    ...
    use olavm_plonky2::field::polynomial::PolynomialValues;
    use olavm_plonky2::field::types::{Field, PrimeField64};
    use olavm_plonky2::fri::oracle::PolynomialBatch;
    use olavm_plonky2::iop::challenger::Challenger;
    use olavm_plonky2::plonk::config::{GenericConfig, PoseidonGoldilocksConfig};
    use olavm_plonky2::timed;
    use olavm_plonky2::util::timing::TimingTree;
