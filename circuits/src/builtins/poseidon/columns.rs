...
pub(crate) const FILTER_LOOKED_NORMAL: usize = 0;
pub(crate) const FILTER_LOOKED_TREEKEY: usize = FILTER_LOOKED_NORMAL + 1;
pub(crate) const FILTER_LOOKED_STORAGE_LEAF: usize = FILTER_LOOKED_TREEKEY + 1;
pub(crate) const FILTER_LOOKED_STORAGE_BRANCH: usize = FILTER_LOOKED_STORAGE_LEAF + 1;
pub(crate) const COL_POSEIDON_INPUT_RANGE: Range<usize> =
    FILTER_LOOKED_STORAGE_BRANCH + 1..FILTER_LOOKED_STORAGE_BRANCH + POSEIDON_INPUT_NUM + 1;
...
pub(crate) fn get_poseidon_col_name_map() -> BTreeMap<usize, String> {
    ...
    m.insert(FILTER_LOOKED_NORMAL, "FILTER_LOOKED_NORMAL".to_string());
    m.insert(
        FILTER_LOOKED_STORAGE_LEAF,
        "FILTER_LOOKED_STORAGE_LEAF".to_string(),
    );
    m.insert(
        FILTER_LOOKED_STORAGE_BRANCH,
        "FILTER_LOOKED_STORAGE_BRANCH".to_string(),
    );
