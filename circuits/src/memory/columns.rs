...
pub(crate) const COL_MEM_S_PROPHET : usize= COL_MEM_S_SCCALL + 1;
...
pub(crate) const COL_MEM_FILTER_LOOKED_FOR_POSEIDON_CHUNK: usize = COL_MEM_FILTER_LOOKED_FOR_MAIN + 1;
pub(crate) const COL_MEM_RW_ADDR_UNCHANGED: usize = COL_MEM_FILTER_LOOKED_FOR_POSEIDON_CHUNK + 1;
